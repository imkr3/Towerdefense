...
const I18N_EN = {
  ...
  '리치의 재림': 'Return of the Lich', '방패벽 관문': 'Shieldwall Gate', '★ 두 트롤의 문': '★ Gate of Two Trolls', '역병의 늪': 'Plague Marsh',
  ...
  '★ 명계의 삼중 봉인': '★ Triple Seal of the Underworld', '리치 소환과 거미 여왕의 독에 대비': "Prepare for lich summons and the queen's venom",
  ...
  /* ---------------- 3막 · 심연의 침공 / 심연의 성소 ---------------- */
  '리바이어던': 'Leviathan', '해신': 'Sea God',
  '5초마다 조류 · 주변 적을 밀어내고 2.5초 둔화 · 넉백 면역': 'Tide every 5s · shoves nearby foes back, slows 2.5s · knockback immune',
  '전선을 통째로 뒤로 밀어낸다. 밀린 적은 다시 걸어와야 하고, 그 사이 뒷줄이 마음껏 쏜다. 다만 혼자서는 느리고 한 번에 하나밖에 못 친다.': 'Shoves the whole line backwards. Pushed foes have to walk in again, and your back rank fires freely meanwhile. Alone it is slow and only ever hits one target.',
  '대해일': 'Great Surge', '전선 전체를 밀어내고 3.5초 둔화.': 'Pushes the entire line back and slows for 3.5s.',
  '해무 마녀': 'Sea Mist Witch', '해무마녀': 'Mist Witch', '소용돌이': 'Maelstrom',
  '범위 · 맞은 적을 끌어당긴다 · 둔화 · 몸이 약함': 'Area · drags struck foes closer · slow · very frail',
  '흩어진 적을 한 덩어리로 끌어모은다. 모인 자리에 범위 공격과 연쇄 번개가 떨어지면 판이 뒤집히지만, 혼자 세워 두면 제일 먼저 쓰러진다.': 'Gathers a scattered enemy line into one clump. Drop area attacks and chain lightning on that clump and the fight turns — but left alone she falls first.',
  '대소용돌이': 'Great Maelstrom', '주변 적을 한곳으로 끌어모으고 피해·둔화.': 'Drags nearby foes into one point, damaging and slowing them.',
  '산호 방벽병': 'Reef Warden', '산호방벽': 'Reef Warden',
  '넉백 면역 · 6초마다 바로 곁의 아군에게 보호막 190': 'Knockback immune · shields adjacent allies for 190 every 6s',
  '산호가 들러붙은 방벽을 세우고 버틴다. 밀려나지 않으니 역류하는 전장에서 값을 한다.': 'Plants a coral-crusted bulwark and holds. Nothing shoves him, so he earns his keep where the undertow runs.',
  '작살잡이': 'Harpooner',
  '일직선 관통 · 꿰뚫린 적을 끌어당긴다': 'Pierces in a line · reels the skewered foe in',
  '줄 달린 작살을 던져 줄 선 적을 한 번에 꿰고, 그대로 당겨 온다.': 'Throws a roped harpoon that skewers everything in a line, then hauls it back.',
  '조수 사제': 'Tide Priest', '조수사제': 'Tide Priest',
  '주변 아군 회복 + 중독·화상·둔화 정화': 'Heals nearby allies and cleanses poison, burn and slow',
  '짠물로 상처를 씻는다. 독과 불, 발에 감긴 물살까지 함께 씻어 낸다.': 'Washes wounds in salt water — and washes off poison, fire and the current around your ankles.',
  '해풍 술사': 'Sea Wind Caster', '해풍술사': 'Wind Caster',
  '방전 · 2번 옮겨 붙는다': 'Arc · jumps twice',
  '바닷바람에 실린 전기를 던진다. 뭉친 적일수록 잘 듣는다.': 'Hurls the charge carried on the sea wind. The tighter the crowd, the better it works.',
  '수병': 'Sailor', '값싼 갈고리 창': 'Cheap hooked pike',
  '갑판에서 끌려 나온 뱃사람. 싸고 빨리 선다.': 'A deckhand dragged ashore. Cheap, and quick to line up.',
  '익사병': 'Drowned', '물에 불은 몸 · 값싼 머릿수': 'Waterlogged body · cheap numbers',
  '심연 유생': 'Abyss Spawn',
  '쓰러지면 익사병 2기로 갈라진다 · 갈라진 것은 다시 갈라지지 않는다': 'Splits into 2 Drowned when it falls · the halves do not split again',
  '산호 게': 'Reef Crab',
  '넉백 면역 · 갑주 30% · 근접 피해 20% 반격': 'Knockback immune · 30% armor · reflects 20% of melee damage',
  '세이렌': 'Siren',
  '범위 노래 · 맞은 아군의 공격력 -40%(4초) · 둔화': 'Area song · struck allies lose 40% ATK for 4s · slow',
  '조수 술사': 'Tidecaller',
  '5초마다 조류 · 주변 아군에게 범위 피해 · 밀어내고 둔화': 'Tide every 5s · area damage to nearby allies · shoves and slows',
  '심연 아귀': 'Abyss Maw',
  '때릴 때마다 군자금 14 약탈 · 흡혈 35%': 'Steals 14 war funds per hit · 35% lifesteal',
  '뇌전 해파리': 'Storm Jelly',
  '방전이 2번 옮겨 붙는다 · 뭉친 전열에 치명적': 'Arc jumps twice · deadly against a packed line',
  '소라 나팔수': 'Conch Warden',
  '주변 적이 받는 피해 -25% · 싸우지 않는다. 먼저 끊어야 한다': 'Nearby foes take 25% less damage · never fights. Cut it first',
  '심연의 크라켄': 'Abyssal Kraken', '먹물 세례': 'Ink Deluge', '촉수의 포옹': 'Tentacle Embrace',
  '심연의 조류': 'Abyssal Current', '먹빛 포효': 'Inkblack Roar', '바다의 광란': 'Ocean Frenzy',
  '뇌우의 마녀': 'Storm Witch', '낙뢰': 'Thunderstrike', '폭풍의 장막': 'Storm Veil',
  '해파리 떼': 'Jelly Swarm', '천둥의 격노': 'Thunderous Fury',
  '심연의 군주': 'Abyss Lord', '심연의 손아귀': 'Grasp of the Abyss', '가라앉은 근위': 'Sunken Guard',
  '만조': 'High Tide', '군주의 포효': "Lord's Roar", '생명의 조수': 'Tide of Life', '심연의 개방': 'The Abyss Opens',
  '밀려온 해안': 'The Risen Shore',
  '심연 유생은 쓰러지면 갈라진다 · 범위 공격으로 한 번에': 'Abyss Spawn split when killed — clear them with area damage',
  '산호의 방벽': 'The Coral Bulwark',
  '산호 게는 근접 반격 · 중독과 원거리로 녹인다': 'Reef Crabs reflect melee — melt them with poison and ranged fire',
  '세이렌의 여울': 'The Siren Shallows',
  '조수 술사가 전열을 밀어낸다 · 넉백 면역과 장거리로': 'Tidecallers shove your line back — bring knockback immunity and range',
  '★ 크라켄의 소용돌이': '★ The Kraken Maelstrom',
  '먹물 낙하 예고를 피하고 유생을 먼저 정리': 'Dodge the ink markers and clear the spawn first',
  '조수의 회랑': 'The Tidal Gallery',
  '소라 나팔수의 가호를 먼저 끊는다 · 뒷줄 폭격과 관통': 'Cut the Conch Wardens first — use backline bombing and piercing shots',
  '★ 뇌우의 등대': '★ The Thunder Beacon',
  '방전은 뭉친 전열에 치명적 · 흩어 세우고 낙뢰를 피한다': 'Arcs punish a packed line — spread out and dodge the strikes',
  '침묵한 나팔': 'The Silenced Horn',
  '비싼 병종은 과녁이 된다 · 값싼 병력으로 가호를 끊어라': 'Costly units are targets — break the wards with cheap troops',
  '심연의 아가리': 'The Abyssal Maw',
  '군자금을 약탈당한다 · 오래 끌지 말고 밀어낸다': 'Your war funds are being stolen — do not let this drag on',
  '공허의 계단': 'The Void Stair',
  '갑주가 두껍고 소환한 아군이 시든다 · 중독·화상과 진짜 병력으로': 'Thick armor, and summons wither — bring poison, burn and real troops',
  '★ 심연의 군주': '★ The Abyss Lord',
  '가호·역류·결계가 겹친다 · 값싼 전열로 나팔수를 끊고 단일 화력으로 군주를 깬다': 'Ward, undertow and veil all at once — cheap ranks to cut the horns, single-target power to break the Lord',
  '심연의 성소': 'Abyssal Sanctum', '가라앉은 바다': 'The Sunken Sea',
  '바다가 뭍으로 올라오자, 그 바다를 지키던 쪽도 함께 올라왔다.': 'When the sea came ashore, the ones who guarded it came with it.',
  '역류': 'Undertow', '아군 이동 속도 -30% · 밀려나는 거리 1.7배': 'Allies move 30% slower · knocked back 1.7× as far',
  '넉백 면역 · 제자리 병종 · 장거리 사격': 'Knockback immunity · units that hold ground · long-range fire',
  '결계': 'Veil', '적이 범위 공격에서 받는 피해 55% 감소 (단일 타격은 그대로)': 'Enemies take 55% less area damage (single hits are unaffected)',
  '단일 고화력 · 관통 · 파쇄 · 처형': 'Single-target burst · pierce · sunder · execute',
  '만신전': 'Pantheon', '모든 시즌에서 전설 이상을 각각 보유': 'Own a Legendary or better from every season',
  '심연의 종결자': 'Ender of the Abyss', '40전장 모두 돌파': 'Clear all 40 stages',
  '가라앉은 왕관': 'The Sunken Crown', '심연의 성소에서 전설 이상 보유': 'Own a Legendary or better from the Abyssal Sanctum',
  '3막': 'Act III', '심연의 침공': 'The Abyss Invades',
  '별의 수확': 'Star Harvest', '별 60개 획득': 'Collect 60 stars',
  '가호 지원 · 뒷줄 폭격과 관통으로 먼저 끊기': 'Ward support · cut it first with backline bombs and pierce',
  '전열을 밀어낸다 · 넉백 면역과 장거리로': 'Shoves your line back · bring knockback immunity and range',
  '쓰러지면 갈라진다 · 범위 공격으로 한 번에': 'Splits when killed · clear it with area damage',
  '군자금 약탈 · 오래 끌지 말고 빨리 끊기': 'Steals war funds · kill it fast, do not let it linger',
  '아군 공격력 저하 · 정화와 사거리로 먼저 끊기': 'Weakens your attack · cleanse, and out-range it',
  '방전 연쇄 · 전열을 뭉치지 말 것': 'Chain arcs · do not bunch your line up',
  '적 증원 시작': 'Enemy reinforcements incoming',
};
