...
const I18N_EN = {
  ...
  '물러서지 않는 등껍질. 때리는 쪽이 더 아프다. 때리는 힘은 거의 없으니, 뒤에 화력을 세워 두고 벽으로만 써야 값을 한다.': 'A shell that never gives ground — whoever strikes it hurts more. It has almost no punch of its own, so use it purely as a wall with firepower behind.',
  '넉백 면역 · 방어 20% · 근접 피해 45% 반격 · 6초마다 주변 보호막 190': 'Knockback immune · 20% armor · reflects 45% melee damage · 190 shield to allies every 6s',
  '등껍질 파동': 'Shell Pulse',
  '가장 가까운 적 주변 피해·1.1초 기절.': 'Damage around the nearest foe · 1.1s stun.',
  '세이렌': 'Siren', '노래': 'Song',
  '바다의 노래로 아군은 빠르게, 적은 느리게 만든다.': "The sea's song speeds allies and slows foes.",
  '5초마다 주변 아군 가속 · 맞은 적 1.4초 둔화': 'Hastes nearby allies every 5s · struck foes slowed 1.4s',
  '문어 장군': 'Octopus General', '문어장군': 'Octopus Gen.', '난격': 'Flail',
  '여덟 팔이 한꺼번에 날아든다. 앞의 여럿을 함께 후려치고 뒤로 밀어낸다.': 'Eight arms come at once, battering several foes and shoving them back.',
  '범위 · 28% 치명타 2.2배 · 밀쳐 냄': 'Area · 28% crit ×2.2 · knockback',
  '진주 무녀': 'Pearl Shaman', '진주무녀': 'Pearl Shaman', '정화': 'Cleanse',
  '진주를 굴려 상처와 독을 함께 씻는다. 독무가 깔린 전장에서는 이 하나가 전열을 살린다.': 'Rolls a pearl that washes away wounds and venom alike. On a fog-choked field, she alone keeps the line alive.',
  '주변 아군 회복 150 · 중독·화상·둔화 해제 · 공격 안 함': 'Heals nearby allies 150 · clears poison, burn and slow · no attack',
  '게 갑사': 'Crab Guard', '게갑사': 'Crab Guard', '집게': 'Pincer',
  '딱딱한 껍질과 커다란 집게. 값싸게 앞줄을 채운다.': 'Hard shell, big pincers. Cheap bodies for the front line.',
  '방어 20% · 근접 피해 15% 반격': '20% armor · reflects 15% melee damage',
  '작살수': 'Harpooner',
  '밧줄 달린 작살을 던진다. 걸린 적은 잠깐 발이 묶인다.': 'Throws a roped harpoon. Whatever it catches is briefly held.',
  '값싼 원거리 · 1초 둔화': 'Cheap ranged · 1s slow',
  '심해 용궁': 'Deep Court', '바다 밑의 조정': 'Court beneath the sea',
  '심연이 올라오자 바다 밑 용궁이 왕국 편에 섰다.': 'When the abyss rose, the court beneath the sea took the kingdom\'s side.',
  ...
  '시궁쥐 떼': 'Ratling Swarm', '아주 빠르고 값싸다 · 범위 공격으로 쓸어라': 'Very fast and cheap · sweep them with area attacks',
  '하피 약탈자': 'Harpy Raider', '사거리 안 가장 뒤의 아군을 노린다 · 흡혈 25%': 'Strikes the farthest ally in range · 25% lifesteal',
  '통곡의 밴시': 'Wailing Banshee', '통곡을 맞은 아군은 피해 30% 감소 · 먼저 끊어라': 'Wailed allies deal 30% less damage · cut her down first',
  '심연 추종자': 'Deep One', '맹독 발톱 · 정화와 해독 훈련으로 버텨라': 'Venomous claws · survive with cleanse and antidote drill',
  '피의 광신도': 'Blood Cultist', '주변 적의 공격력 +40% · 후방 지원부터 잘라라': 'Nearby foes gain +40% ATK · cut the support first',
  '강철 망치병': 'Iron Maul', '방어 30% · 넉백 면역 · 30% 확률로 0.7초 기절': '30% armor · knockback immune · 30% chance of a 0.7s stun',
  '심연의 촉수': 'Abyssal Tentacle', '땅에 박혀 멀리서 휘감는다 · 맞으면 둔화': 'Rooted, it lashes from afar · its hits slow',
  '공성탑': 'Siege Tower', '넉백 면역 · 방어 25% · 7초마다 병력을 쏟아낸다': 'Knockback immune · 25% armor · pours out troops every 7s',
  '아홉머리 히드라': 'Nine-Headed Hydra', '삼중 독액': 'Triple Venom', '머리 분열': 'Splitting Heads',
  '재생의 늪': 'Regenerating Mire', '아홉 겹 분노': 'Ninefold Fury',
  '초당 130 재생 · 화상 중에는 재생 중단': 'Regen 130 HP/s · stops while burning',
  '심연의 레비아탄': 'Abyssal Leviathan', '해일': 'Tidal Surge', '심해의 포효': 'Deep Roar',
  '삼중 조수': 'Triple Tide', '조수의 격노': 'Fury of the Tide',
  '맞은 아군은 둔화 · 방어 20% · 해일은 전장 절반을 얼린다': 'Its hits slow · 20% armor · the surge freezes half the field',
  '심연왕': 'Abyss Lord', '심연의 손아귀': 'Grasp of the Abyss', '촉수 소환': 'Call the Tentacles',
  '심연의 부름': 'Call of the Abyss', '심해의 장막': 'Veil of the Deep', '왕의 최후': "King's Last Stand",
  ...
  '조수가 삼킨 해안': 'Tide-Swallowed Shore', '쥐 떼는 범위 공격으로 한 번에 쓸어라': 'Sweep the ratlings with area attacks',
  '통곡하는 등대': 'The Wailing Lighthouse', '밴시의 통곡은 아군 피해를 깎는다 — 먼저 끊어라': "The banshee's wail cuts your damage — silence her first",
  '★ 아홉머리의 늪': '★ Mire of Nine Heads', '히드라는 재생한다 — 화상으로 재생을 끊고 몰아쳐라': 'The hydra regenerates — burn it to stop the healing, then press',
  '가라앉은 성채': 'The Sunken Keep', '공성탑이 병력을 토해낸다 — 탑을 먼저 부수는 편이 빠르다': 'Siege towers keep spilling troops — breaking the tower is faster',
  '피의 제단': 'Altar of Blood', '광신도가 주변 적을 강화한다 — 후열부터 도려내라': 'Cultists buff everything near them — carve out the back rank first',
  '★ 레비아탄의 해구': '★ Trench of the Leviathan', '해일이 오면 둔화가 겹친다 — 넉백 면역 앞줄로 버텨라': 'The surge stacks slows — hold with a knockback-immune front',
  '숨 막히는 안개 습지': 'Choking Fen', '독무가 전군을 좀먹는다 — 치유와 재생 없이는 못 버틴다': 'Venom fog eats the whole army — you cannot hold without healing',
  '번개 치는 난바다': 'Thunderstruck Open Sea', '폭풍이 화살을 밀어낸다 — 근접 주력으로 짜라': 'The storm shoves arrows aside — build around melee',
  '★ 심연의 관문': '★ Gate of the Abyss', '간조로 카드가 늦게 돌아온다 — 오래 버티는 병종을 아껴 써라': 'Low tide slows every redeploy — spend durable units carefully',
  '★ 심연왕의 옥좌': '★ Throne of the Abyss Lord', '모든 특성이 한꺼번에 걸린다 — 특성마다 하나씩 답을 챙겨 와라': 'Every trait is active at once — bring one answer for each',
  ...
  '흠 없는 진군': 'Flawless March', '별 60개 획득': 'Earn 60 stars',
  '모든 신화': 'Every Myth', '모든 시즌에서 전설 이상을 각각 보유': 'Own a Legend+ from every season',
  ...
  '독무': 'Venom Fog', '아군 전원이 초당 26 피해를 계속 받는다 (정화로는 못 걷는다)': 'Every ally takes 26 damage/s (cleanse cannot lift it)',
  '치유 · 재생 · 해독 훈련 · 체력 큰 병종': 'Healing · regeneration · antidote drill · high-HP units',
  '폭풍 전선': 'Storm Front', '아군 원거리 사거리 28% 감소 (사거리 150 초과 병종)': 'Ally range -28% (units with range over 150)',
  '근접 주력 · 단단한 앞줄 · 사거리에 기대지 않는 편성': 'A melee core · a solid front · a squad that does not lean on range',
  '간조': 'Low Tide', '아군 재출진 대기 +45%': 'Ally redeploy cooldowns +45%',
  '병참 강화 · 값싼 병종 · 한 번에 오래 버티는 병종': 'Logistics upgrades · cheap units · units that last',
