...
const ENEMIES = {
  ...
  cultist:  { name: '그림자 신도', body: '#4c4260', accent: '#b489ff', tunic: '#332c45', shape: 'cultist',
  ...
  hexer:    { name: '저주술사', body: '#5b4a70', accent: '#e6a0f0', tunic: '#3f2f4d', shape: 'hexer',
  ...
  abysslord:{ name: '심연의 군주', body: '#3d3352', accent: '#b98aff', tunic: '#4a3d6b', shape: 'abysslord',
  ...
  shadowking:{ name: '그림자 왕', body: '#39344a', accent: '#ff6b7e', tunic: '#4b4266', shape: 'shadowking',
